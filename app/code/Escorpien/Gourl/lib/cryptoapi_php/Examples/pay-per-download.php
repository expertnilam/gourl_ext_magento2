 ...
 */ 
	...
	$userID		= "sanket1990";		// optional; place your registered userID or md5(userID) here (user1, user7, uo43DC, etc).
	...
	$public_key		= "17664AAMlnCABitcoin77BTCPUBKDsBN81FX2v8hBYhJFYJ6Qs"; // from gourl.io
	$private_key	= "17664AAMlnCABitcoin77BTCPRV0PoblLrpGA0joush9kItQLk";// from gourl.io
