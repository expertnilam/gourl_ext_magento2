...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('coin');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Escorpien\Gourl\Model\Coin')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('gourl/*/index');
    }
